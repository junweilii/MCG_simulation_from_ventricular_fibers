...
#define nrn_init _nrn_init__Na_acc
#define _nrn_initial _nrn_initial__Na_acc
#define nrn_cur _nrn_cur__Na_acc
#define _nrn_current _nrn_current__Na_acc
#define nrn_jacob _nrn_jacob__Na_acc
#define nrn_state _nrn_state__Na_acc
#define _net_receive _net_receive__Na_acc 
#define state state__Na_acc 
...
#define Naneutral _p[0]
#define Naneutral_columnindex 0
#define Vi _p[1]
#define Vi_columnindex 1
#define ina _p[2]
...
#define _ion_ina	*(_ppvar[0].get<double*>())
#define _ion_nai	*(_ppvar[1].get<double*>())
#define _style_na	*_ppvar[2].get<int*>()
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_Na_acc", _hoc_setdata},
 {0, 0}
};
 /* declare global and static user variables */
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 {"Naneutral_Na_acc", 0, 1e+06},
 {0, 0, 0}
};
 static HocParmUnits _hoc_parm_units[] = {
 {"Naneutral_Na_acc", "mA/cm2"},
 {"Vi_Na_acc", "cm3"},
 {0, 0}
};
 static double delta_t = 0.01;
 static double nai0 = 9.19;
 static double v = 0;
...
static void nrn_alloc(Prop* _prop) {
 ...
 nrn_promote(prop_ion, 3, 0);
 	_ppvar[0] = &prop_ion->param[3]; /* ina */
 	_ppvar[1] = &prop_ion->param[1]; /* nai */
 	_ppvar[2] = &(prop_ion->dparam[0].literal_value<int>()); /* iontype for na */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Na_acc nacum.mod\n");
...
_deriv1_advance = 0;
 if(error){fprintf(stderr,"at line 37 in file nacum.mod:\nBREAKPOINT {\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 1; ++_i) {
...
static void _initlists() {
 ...
 _slist2[0] = nai_columnindex;
_first = 0;
}

#if NMODL_TEXT
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "nacum.mod";
